...
const PhoneCode = ({setPhone}) => {
    ...
    const handleChange = (e) => {
        ...
        const select = document.querySelector('#c-p-c');
        setDbLetter(select.selectedOptions[0].dataset.countrycode.toLowerCase())
    }

    const handleNumber = (e) => {
        setNumber(e.target.value)
        setPhone(`+${phoneCode}${number}`)
    }
    ...
    return (
        ...
        <div className="phone-wrap">
            <div className="select">
                <div className="c-img">
                    <img src={`https://flagpedia.net/data/flags/h80/${dbLetter}.webp`} alt="flags" />
                </div>
                <select
                name="country-code" 
                id='c-p-c'
            ...
            <div className="code-wrap">
                <div className="ctry-code"><span>{`+${phoneCode}`}</span></div>
                <input 
                    type="tel"
