...
import smallUp from '../../assets/icons/small-up.svg'
import smallDown from '../../assets/icons/small-down.svg'
        ...
        <div className="edu-two">
            <div className="edu-two-wrap">
                ...
                <div className="content">
                    <div className="tenth">
                        <span className='info'>10<sup>th</sup> Percentage</span>
                        <label>
                    ...
                    <div className="twelveth">
                        <span className='info'>12<sup>th</sup> Percentage</span>
                        <label>
                            <input type="file" name="" id="" />
                            <div className="upload">
                                <span>Upload DOC</span>
