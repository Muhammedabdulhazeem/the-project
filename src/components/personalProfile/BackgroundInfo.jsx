...
import dropDown from '../../assets/icons/blue-drop-down.svg'
import underOne from '../../assets/icons/back-under1.svg'
import underTwo from '../../assets/icons/back-under2.svg'
    ...
    return (
        <div className="background-info">
            <Link style={{color: "black"}} to='/dashboard/'>
                <p onClick={() => setShowNavs(true)} className='back'>BACK</p>
            </Link>
