...
import vidImg from '../../assets/images/vid-image.png'

const GmatPage = () => {
    return (
        <div className="gmat-page">
            <h1>GMAT online learning provide you useful materials to help you get started</h1>
